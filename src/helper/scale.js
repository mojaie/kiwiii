...
const colorRangeTypes = [
  ...
  {key: 'category20', name: 'Categorical 20', size: 20,
   range: d3.schemeCategory20, unknown: '#fefefe'},
  {key: 'category40', name: 'Categorical 40', size: 40,
   range: d3.schemeCategory20b.concat(d3.schemeCategory20c), unknown: '#fefefe'}
];
